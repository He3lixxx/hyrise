...
class ValueSegmentIterable : public PointAccessibleSegmentIterable<ValueSegmentIterable<T>> {
 public:
  using ValueType = T;
  using PointAccessibleSegmentIterable<ValueSegmentIterable<T>>::_on_with_iterators;  // needed because of “name hiding”
 ...
 private:
  ...
  class PointAccessIterator : public BasePointAccessSegmentIterator<PointAccessIterator<_SubIteratorType>, SegmentPosition<T>, _SubIteratorType> {
   ...
   public:
    explicit PointAccessIterator(ValueVectorIterator values_begin_it,
                                 NullValueVectorIterator null_values_begin_it,
                                 const _SubIteratorType position_filter_begin,
                                 _SubIteratorType position_filter_it)
        : BasePointAccessSegmentIterator<PointAccessIterator<_SubIteratorType>,
                                         SegmentPosition<T>, _SubIteratorType>{std::move(position_filter_begin),
                                                          std::move(position_filter_it)},
          _values_begin_it{values_begin_it},
